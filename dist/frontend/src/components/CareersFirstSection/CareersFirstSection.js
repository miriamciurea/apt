...
const CareersFirstSection = () => {
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)("div", { className: CareersFirstSection_module_css_1.default.container, children: [(0, jsx_runtime_1.jsxs)("h1", { className: CareersFirstSection_module_css_1.default.title, children: ["THRILLED TO WELCOME ", (0, jsx_runtime_1.jsx)("span", { className: CareersFirstSection_module_css_1.default.highlight, children: "YOU" }), " TO", " ", (0, jsx_runtime_1.jsx)("span", { children: "OUR TEAM" })] }), (0, jsx_runtime_1.jsx)("h2", { className: CareersFirstSection_module_css_1.default.subTitle, children: "WHY JOIN US?" }), (0, jsx_runtime_1.jsxs)("div", { className: CareersFirstSection_module_css_1.default.reasonsContainer, children: [(0, jsx_runtime_1.jsx)("div", { children: items.map((item) => {
