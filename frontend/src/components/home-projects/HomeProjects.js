...
const HomeProjects = () => {
    ...
    return (_jsxs("div", { className: styles.container, children: [_jsx("div", { className: styles.title, children: "FEATURED PROJECTS" }), _jsx("div", { className: styles.projects, ref: projectsRef, children: projects.map((project, index) => (_jsxs("div", { className: styles.project, children: [_jsx("div", { className: styles.projectImage, style: {
                                ...
                                margin: '20px',
                            } }), _jsx("div", { className: styles.projectInfo, style: {
