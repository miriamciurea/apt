...
const Slider = () => {
    ...
    return (_jsx("div", { className: styles.home, children: _jsx("div", { className: styles.background, style: { backgroundImage: `url(${imageUrl})`, backgroundPosition: 'var(--background-position)' }, children: _jsxs("div", { className: styles.overlay, children: [_jsx("div", { className: styles.title, children: _jsx("h1", { children: "JOIN OUR COMMUNITY" }) }), _jsx("div", { className: styles.text, children: _jsxs("p", { children: ["In the ever-changing construction industry, we\u2019re proud to offer ", _jsx("span", { className: "highlight", children: "competitive benefits" }), " along with an ", _jsx("span", { className: "highlight", children: "education allowance" }), " to help employees continue to learn and develop. We strive to foster a work environment where relationships are valued and every team member is treated with ", _jsx("span", { className: "highlight", children: "trust and respect" }), "."] }) }), _jsx("div", { className: styles.link, children: _jsx("a", { href: "your-link-url", className: styles.homeLink, children: "Our Career Opportunities >>" }) })] }) }) }));
};
