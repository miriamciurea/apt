...
const Home = () => {
    return (_jsxs(_Fragment, { children: [_jsx(Hero, {}), _jsxs("div", { className: "container", children: [_jsx(Domain, {}), _jsx(HomeProjects, {}), _jsx(Loop, {}), _jsx(Slider, {}), _jsx(CompanyValues, {}), _jsx(Reviews, {}), _jsx(Cta, {})] })] }));
};
export default Home;
