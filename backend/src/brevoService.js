...
var sendContactEmail = function (formData) { return __awaiter(void 0, void 0, void 0, function () {
    var defaultClient, apiKey, apiInstance, sendSmtpEmail, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                sendSmtpEmail.to = [{ email: 'adrianpearson@apt.info' }];
                sendSmtpEmail.sender = { email: 'adrianpearson@apt.info', name: 'APT' };
                sendSmtpEmail.subject = "New Contact Form Submission from ".concat(formData.name);
                sendSmtpEmail.textContent = "\n    You have received a new contact form submission.\n    Name: ".concat(formData.name, "\n    Email: ").concat(formData.email, "\n    Phone: ").concat(formData.phone, "\n    Interest: ").concat(formData.interest, "\n    More Information: ").concat(formData.moreInfo, "\n  ");
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
